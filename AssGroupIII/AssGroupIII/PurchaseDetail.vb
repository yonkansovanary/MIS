...
Public Class PurchaseDetail
    ...
    FROM purchase left join sec_user on employee_id=sec_user.id  where is_deleted = '0'")
    End Function
    Private Function getAllPurchaseDetail()
        DataGridViewPurchaseDetail.DataSource = myCon.listAllData(
   "SELECT purchase.code 'Purchase Code',product.name 'Product Name',purchase_detail.unit_price 'Unit Price',unit_of_measure.name UOM ,qty 'Qty',shipping.shipping_method 'Shipping',purchase_detail.status 'Status',supplier.supplier_name 'Supplier Name',total_price 'Total Price',purchase_detail.date_created 'Date Created'
